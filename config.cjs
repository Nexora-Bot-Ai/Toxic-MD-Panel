...
const config = {
  SESSION_ID: process.env.SESSION_ID || "NEXORA-BOT~xqV0GALxGcIQDfqNSR6Ssi8gH",
  ...
  BOT_NAME: process.env.BOT_NAME || "NEXORA-BOT",
  MENU_IMAGE: process.env.MENU_IMAGE || "https://i.ibb.co/JRvZBgDK/temp.jpg",
  DESCRIPTION: process.env.DESCRIPTION || "I Am NEXORA-BOT WhatsApp Bot Created by ArslanMD Official",
  OWNER_NAME: process.env.OWNER_NAME || "NEXORA-BOT",
